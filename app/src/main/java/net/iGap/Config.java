...
public class Config extends Application {
    ...
    public static String default_appBarColor = "#1b908a";
    public static String default_notificationColor = "#1b908a";
    public static String default_toggleButtonColor = "#1b908a";
    public static String default_attachmentColor = "#1b908a";
    public static String default_headerTextColor = "#1b908a";
    public static String default_progressColor = "#1b908a";
    public static String LINK_COLOR = "#0000EE";


    public static long INTRO_ANIM_DURATION = 100L;
    public static long INTRO_GO_TO_APP_ANIM_DURATION = 50000L;
    public static long INTRO_ANIM_DELAY_IN_DURATION = 100L;
    public static int DEFAULT_DATE =1;  /*milady=0  shamsi=1 ghamari=2*/
    public static int TAB_HEIGHT =1;  /*milady=0  shamsi=1 ghamari=2*/
}
