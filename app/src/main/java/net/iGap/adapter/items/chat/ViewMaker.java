...
//        txt_views_label.setTextColor(context.getResources().getColor(R.color.room_message_gray));
        ...
        img_eye.setTextColor(context.getResources().getColor(R.color.seen_icon_color));
    ...
    static View getViewVote() {
        ...
        lyt_vote_sub.setBackgroundDrawable(G.context.getResources().getDrawable(R.drawable.rectangel_channel_message));
        ...
        txt_vote_up.setTextColor(context.getResources().getColor(R.color.vote_number_color));
        ...
        img_vote_up.setTextColor(context.getResources().getColor(R.color.vote_icon_color));
        ...
        img_vote_down.setTextColor(context.getResources().getColor(R.color.vote_icon_color));
        ...
        txt_vote_down.setTextColor(context.getResources().getColor(R.color.vote_number_color));
    ...
    private static View getForwardButton() {
        ...
        img_vote_forward.setTextColor(context.getResources().getColor(R.color.vote_icon_color));
    ...
    public static View getViewItemRoom() {
        ...
        LinearLayout.LayoutParams layout_553 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, i_Dp(R.dimen.dp75));
        root_chat_sub_layout.setLayoutParams(layout_553);

        //region cs_img_contact_picture
        ...
        LinearLayout.LayoutParams layout_113 = new LinearLayout.LayoutParams(i_Dp(R.dimen.dp60), i_Dp(R.dimen.dp60));
        ...
        linearLayout_922.addView(cs_txt_mute);
