...
//             View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_sub_layout, parent, false);
//            return new ViewHolder(v);
        ...
        public void onBindViewHolder(final ViewHolder holder, final int i) {
            ...
            if (mInfo.isValid()) {
                ...
                holder.name.setText(mInfo.getTitle().trim());
                if (mInfo.getTitle().equals("iGap Messenger")) {
                    holder.name.setText(getString(R.string.app_name));
                ...
                if (isMyCloud) {
                    ...
                    holder.name.setText(R.string.chat_with_yourself);
                        ...
                        if (mInfo.getLastMessage() != null) {
                            ...
                            if (result.isEmpty()) {
                                ...
                                if (fileText != null && !fileText.isEmpty()) {
                                    ...
                                    holder.txtLastMessageFileText.setTextColor(ContextCompat.getColor(context, R.color.room_message_gray));
