...
public class FragmentIntroduce extends BaseFragment {
    ...
    private long ANIM_DURATION = Config.INTRO_ANIM_DURATION;
    private long GO_TO_APP_ANIM_DURATION = Config.INTRO_GO_TO_APP_ANIM_DURATION;
...
/*      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            color = t.getColor(0, resources.getColor(net.iGap.messageprogress.R.color.cpv_default_color));
        } else {
            //Use default color
            color = resources.getColor(net.iGap.messageprogress.R.color.cpv_default_color);
        }*/
        logoSecurity = (ImageView) view.findViewById(R.id.int_img_security_introduce);
//        logoSecurity.setColorFilter(getContext().getColor(R.color.gray));
        ...
        animator.setDuration(GO_TO_APP_ANIM_DURATION);
    ...
    private void getInfo() {
        ...
        }, Config.INTRO_ANIM_DELAY_IN_DURATION);
    }
