    ...
    public static void rightMessageStatus(ImageView view, ProtoGlobal.RoomMessageStatus status, boolean isSenderMe) {
        ...
        switch (status) {
            ...
            case SEEN:
                ...
                setImageDrawable(view, R.drawable.ic_double_check);
                view.setColorFilter(view.getContext().getResources().getColor(R.color.check_seen_color));
                break;
            case SENDING:
            ...
            case SENT:
                ...
                view.setColorFilter(view.getContext().getResources().getColor(R.color.check_color));
                break;
            default:
                view.setVisibility(View.GONE);
                break;
    ...
    public static void rightMessageStatus(ImageView view, ProtoGlobal.RoomMessageStatus status, ProtoGlobal.RoomMessageType messageType, boolean isSenderMe) {
        ...
        switch (status) {
            ...
            case SEEN:
                ...
                DrawableCompat.setTintList(wrappedDrawable, ColorStateList.valueOf(view.getContext().getResources().getColor(R.color.check_seen_color)));
                break;
            case SENDING:
