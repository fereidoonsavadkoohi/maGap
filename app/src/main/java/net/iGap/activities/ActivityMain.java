...
import net.iGap.helper.Setting;
...
import static net.iGap.R.string.settings;
...
public class ActivityMain extends ActivityEnhanced implements OnUserInfoMyClient, OnUnreadChange, OnClientGetRoomListResponse, OnChatClearMessageResponse, OnChatSendMessageResponse, OnClientCondition, OnGroupAvatarResponse, DrawerLayout.DrawerListener, OnMapRegisterStateMain {
    ...
    private FloatingActionButton btnStartNewChat;
    private FloatingActionButton btnCreateNewGroup;
    private FloatingActionButton btnCreateNewChannel;
    private SampleFragmentPagerAdapter sampleFragmentPagerAdapter;
    private boolean waitingForConfiguration = false;
    ...
    private static void setWeight(View view, int value) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        FrameLayout _mainframe = findViewById(R.id.frame_main);
        ...
        LinearLayout mediaLayout = findViewById(R.id.amr_ll_music_layout);
    ...
    private void onSelectItem(int position) {
        ...
        if (adapter.getItem(position) instanceof FragmentMain) {
            ...
            setFabIcon(R.drawable.ic_call);/*ic_call_black_24dp)*/
        }
...
/*                int index;
                ...
                navigationTabStrip.setViewPager(mViewPager, Setting.getCurrentTabIndex());
                if (!HelperCalander.isPersianUnicode) {
                ...
                navigationTabStrip.setOnTabStripSelectedIndexListener(new NavigationTabStrip.OnTabStripSelectedIndexListener() {
                    ...
                    public void onEndTabSelected(String title, int index) {
                        onSelectItem(index);
                        Setting.setCurrentTabIndex(index);
                    }
                });
    ...
    private void initTabStrip() {
        ...
        navigationTabStrip.setTitleSize(getResources().getDimension(R.dimen.dp18));
    ...
    private void initDrawerMenu() {
        ...
        ViewGroup igapSearch = findViewById(R.id.lm_ll_igap_search);
        ...
        itemNavSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.share_txt));
    ...
    private void initComponent() {
        ...
        iconLocation = findViewById(R.id.am_btn_location);
        ...
        RippleView rippleSearch = findViewById(R.id.amr_ripple_search);
    ...
    private void stopAnimationLocation() {
        if (iconLocation != null) {
            iconLocation.setVisibility(View.GONE);
        }
    }

    private void startAnimationLocation() {
        if (iconLocation != null) {
...
//                    G.selectedTabInMainActivity = fm.mainType.toString();
                    ...
                    Setting.setCurrentTabIndex(4);
//                    G.selectedTabInMainActivity = 4;adapter.getItem(mViewPager.getCurrentItem()).getClass().getName();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void setImage() {
        HelperAvatar.getAvatar(G.userId, HelperAvatar.AvatarType.ROOM, true, new OnAvatarGet() {
            @Override
    ...
    private void designLayout(final chatLayoutMode mode) {
